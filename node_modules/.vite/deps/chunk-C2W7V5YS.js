...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    const element = (0, import_jsx_runtime12.jsxs)(React24.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime12.jsxs)(React24.Fragment, {
...
var FormControl = React33.forwardRef(function FormControl2(props, forwardedRef) {
  var _slots$root;
  const {
    defaultValue,
    children,
  ...
  React33.useEffect(() => setFocused((isFocused) => disabled ? false : isFocused), [disabled]);
  const ownerState = _extends({}, props, {
    disabled,
    error,
    filled,
...
var Input = React36.forwardRef(function Input2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime22.jsxs)(Root, _extends({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime21.jsx)(InputComponent, _extends({}, inputProps)), endAdornment]
  }));
});
...
function useSelectChangeNotifiers() {
  ...
  const notifySelectionChanged = React38.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React38.useCallback((newHighlightedItem) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC, newHighlightedItem);
  }, [messageBus]);
  const registerSelectionChangeHandler = React38.useCallback((handler) => {
    return messageBus.subscribe(SELECTION_CHANGE_TOPIC, handler);
  }, [messageBus]);
  const registerHighlightChangeHandler = React38.useCallback((handler) => {
...
function useForcedRerendering() {
  const [, setState] = React43.useState({});
...
function useListItem(parameters) {
  ...
  const createHandleClick = React45.useCallback((other) => (event) => {
    var _other$onClick;
  ...
  const createHandlePointerOver = React45.useCallback((other) => (event) => {
...
function useMenu(parameters = {}) {
  ...
  const stateChangeHandler = React47.useCallback((event, field, fieldValue, reason, state) => {
    if (field === "open") {
...
var Portal = React49.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React49.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime24.jsx)(React49.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime24.jsx)(React49.Fragment, {
...
var _excluded24 = ["actions", "anchorEl", "children", "defaultOpen", "listboxId", "onItemsChange", "onOpenChange", "open", "slotProps", "slots"];
...
var _excluded25 = ["children", "disabled", "label", "slotProps", "slots"];
...
var MenuItem = React54.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var _excluded26 = ["children", "closeAfterTransition", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "manager", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
var Modal = React55.forwardRef(function Modal2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsx)(
    Portal_default,
    {
      ...
      container,
      disablePortal,
      children: (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
        children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime28.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime28.jsx)(FocusTrap_default, {
          disableEnforceFocus,
          disableAutoFocus,
          disableRestoreFocus,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(React56.Fragment, {
...
var Option = React59.forwardRef(function Option2(props, forwardedRef) {
...
var Option_default = React59.memo(Option);
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime35.jsx)(React62.Fragment, {
...
var Select = React62.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime36.jsxs)(React62.Fragment, {
...
var Slider = React64.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime38.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime37.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime37.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime38.jsxs)(React64.Fragment, {
...
function useSnackbar(parameters) {
  ...
  const timerAutoHide = React65.useRef();
  React65.useEffect(() => {
    if (!open) {
      return void 0;
    }
...
var TextareaAutosize = React82.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const renders = React82.useRef(0);
  const [state, setState] = React82.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React82.useCallback(() => {
  ...
  return (0, import_jsx_runtime53.jsxs)(React82.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-C2W7V5YS.js.map
